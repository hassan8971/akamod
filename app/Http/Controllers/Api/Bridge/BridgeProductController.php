...
class BridgeProductController extends Controller
{
    ...
    private function syncProductToWordPress($product)
    {
        ...
        $imageUrls = [];
        $remoteStorage = 'https://api.akaleather.com/storage/'; // استفاده از آدرس دقیق لاراول شما
        ...
        try {
            ...
            ])->post('https://akaleather.com/wp-json/akamode/v1/sync-product', $data); // آدرس سایت وردپرسی‌ات
