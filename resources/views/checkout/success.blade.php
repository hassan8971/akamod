...
<div class="container mx-auto px-4 py-12">
    <div class="bg-white shadow-lg rounded-lg max-w-2xl mx-auto p-8 text-center">
        ...
        <p class="text-gray-500 mt-4">Your Order ID is: <span class="font-medium text-gray-700">#{{ $order->id }}</span></p>
        <p class="text-gray-500">We've sent a confirmation email to you (if you provided one).</p>
