<template x-if="selectedItem.type === 'mag_update_banner'">
    <div>
        ...
        <div>
            <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 mb-1">متن بالای تصویر</label>
            <input type="text" x-model="selectedItem.config.upperText" placeholder="" class="w-full text-sm border-gray-300 dark:border-gray-600 dark:bg-dark-bg dark:text-white rounded-md dir-ltr text-left">
        </div>
        ...
        <div>
            ...
            <input type="text" x-model="selectedItem.config.titleDesc" placeholder="" class="w-full text-sm border-gray-300 dark:border-gray-600 dark:bg-dark-bg dark:text-white rounded-md dir-ltr text-left">
        </div>
