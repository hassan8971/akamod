<template x-if="section.type === 'single_product'">
    <div class="mt-6">
        ...
        <div class="grid grid-cols-1 gap-3 px-4 pb-2 no-scrollbar" style="column-gap: 5rem;">
            <template x-for="app in getPreviewApps(section)" :key="app.id">
                <div class="min-w-[70px] flex flex-col gap-1 cursor-default" style="justify-content: flex-end;">
